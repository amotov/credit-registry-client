...
public class FileUtil {
    ...
    public static com.bsbnb.creditregistry.client.util.File getFile() {
        return _file;
    }
    ...
    public void setFile(com.bsbnb.creditregistry.client.util.File file) {
        _file = file;
    }
    private static com.bsbnb.creditregistry.client.util.File _file;
}